  ...
  return (
    <div className="animate-fade-in relative pt-6">
      ...
      <div className="flex justify-between items-end">
        ...
        <button className="bg-slate-900 text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/20 flex items-center gap-2">
             <BarChart3 size={18} /> Buat Laporan
        </button>
      </div>
                ...
                <tr><td colSpan={4} className="px-8 py-12 text-center text-sm text-slate-400 font-medium italic">Tidak ada pendaftaran terbaru.</td></tr>
                    ...
                    <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-8 py-5 text-right">
                            <button className="text-slate-400 hover:text-primary-600 hover:bg-primary-50 p-2 rounded-xl transition-all">
